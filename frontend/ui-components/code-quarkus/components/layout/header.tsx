...
import {getQueryStreamKey, normalizeStreamKey} from "../api/quarkus-project-utils";
...
export function Header(props: { supportButton: boolean, platform: Platform }) {
  ...
  const streamKey = normalizeStreamKey(recommendedStreamKeys[0], getQueryStreamKey()) || recommendedStream.key;
  const streamKeys = streamKey.split(':');
  return (
